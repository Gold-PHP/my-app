                                                ...
                                                <div className="product-item">
                                                    ...
                                                    <div className="d-flex align-items-center justify-content-between">
                                                        <div className="input-group product-qty">
                                                            ...
                                                            <input type="text" id="quantity" name="quantity" className="htmlForm-control input-number" value="1" />
                                                            <span className="input-group-btn">
                                                                <button type="button" className="quantity-right-plus btn btn-success btn-number" data-type="plus">
                                                                    <svg width="16" height="16"><use xlinkHref="#plus"></use></svg>
                                                                </button>
                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="banner-ad bg-danger mb-3" style={{ background: "url('images/ad-image-3.png') no-repeat", backgroundPosition: "right bottom" }}>
                        ...
                        <div className="col-md-6">
                            <div className="banner-ad bg-info" style={{ background: "url('images/ad-image-4.png') no-repeat", backgroundPosition: "right bottom" }}>
                                <div className="banner-content p-5">
                                ...
                                <div className="col-md-6 p-5">
                                    <htmlForm>
                                        <div className="mb-3">
                                            ...
                                            <input type="text"
                                                className="htmlForm-control htmlForm-control-lg" name="name" id="name" placeholder="Name" />
                                        </div>
                                        <div className="mb-3">
                                            <label htmlFor="" className="htmlForm-label">Email</label>
                                            <input type="email" className="htmlForm-control htmlForm-control-lg" name="email" id="email" placeholder="abc@mail.com" />
                                        </div>
                                        <div className="htmlForm-check htmlForm-check-inline mb-3">
                                            <label className="htmlForm-check-label" htmlFor="subscribe">
                                                <input className="htmlForm-check-input" type="checkbox" id="subscribe" value="subscribe" />
                        ...
                        <div className="col-md-4">
                            <article className="post-item card border-0 shadow-sm p-3">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="post-header">
                                        <h3 className="post-title">
                                            <a href="#" className="text-decoration-none">10 Different Types of comhtmlFortable clothes ideas htmlFor women</a>
                                        </h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipi elit. Aliquet eleifend viverra enim tincidunt donec quam. A in arcu, hendrerit neque dolor morbi...</p>
                                    </div>
                                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2 col-sm-6">
                            <div className="footer-menu">
                                ...
                                <ul className="menu-list list-unstyled">
                                    ...
                                    <li className="menu-item">
                                        <a href="#" className="nav-link">Delivery InhtmlFormation</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="footer-menu">
                                ...
                                <htmlForm className="d-flex mt-3 gap-0" role="newsletter">
                                    <input className="htmlForm-control rounded-start rounded-0 bg-light" type="email" placeholder="Email Address" aria-label="Email Address" />
